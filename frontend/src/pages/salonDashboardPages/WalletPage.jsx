...
import WithdrawFundsModal from "../../components/modals/salonDashboardModals/WithdrawFundsModal";

const SalonWalletPage = () => {
  ...
  return (
    <div className="p-6 space-y-6 px-16">
      <div>
        ...
        <p className="text-gray-500">Manage your earnings & payouts</p>
      </div>
      ...
      <div className="bg-gray border border-gray-300 rounded-2xl">
        <p className="text-blue-900 p-4 text-sm">
          <span className="font-bold">Note:</span> All payments are held in escrow until service completion.
          After completion, 90% is released to your wallet (10% platform
          commission deducted)
        </p>
      </div>
...
export default SalonWalletPage;
