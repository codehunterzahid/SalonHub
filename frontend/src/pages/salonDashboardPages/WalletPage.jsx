...
const SalonWalletPage = () => {
  ...
  return (
    <WalletLayout
      title="Wallet"
      subtitle="Manage your earnings & payouts"
      balance={balance}
      ...
      note="All payments are held in escrow until service completion. After completion, 90% is released to your wallet (10% platform commission deducted)."
      modal={
        <WithdrawFundsModal
          isOpen={showModal}
