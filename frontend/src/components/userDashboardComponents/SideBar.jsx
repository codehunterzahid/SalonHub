  ...
  return (
    <div className="w-64 bg-white shadow-lg p-6 flex flex-col">
      ...
      <div className="flex items-center mb-4 py-4">
        ...
        <span className="ml-2 font-bold text-xl bg-linear-to-r from-purple-500 to-pink-500 bg-clip-text text-transparent">SalonHub</span>
      </div>
      ...
      <nav className="flex-1">
        <NavLink
          to="/browse"
          className="flex items-center mb-4 px-3 py-3 rounded-lg text-white bg-linear-to-r from-purple-500 to-pink-500"
        >
          <Search className="mr-2" /> Browse Salons
        </NavLink>
        <NavLink
          to="/bookings"
          className="flex items-center mb-4 px-3 py-3 rounded-lg text-gray-700 hover:bg-gray-100"
        >
