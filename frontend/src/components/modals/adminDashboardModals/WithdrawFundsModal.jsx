...
const WithdrawFundsModal = ({ isOpen, onClose, amount, setAmount, onWithdrawFunds }) => {
  ...
  return (
    <div className="fixed inset-0 bg-black/40 flex items-center justify-center z-50">
      <div className="bg-white rounded-2xl w-full max-w-md p-6 relative">
        ...
        <h2 className="text-xl font-bold mb-4 text-black">Withdraw Funds from Wallet</h2>
        ...
        <div className="flex gap-3">
          ...
          <button
            onClick={() => onWithdrawFunds(Number(amount))}
            disabled={!amount}
